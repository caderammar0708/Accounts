    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'auth' => [
                ...
                'branches_enabled'           => $companySetting?->branches_enabled ?? false,
                ...
                'current_location'        => session('current_location_id') ? \App\Models\Location::find(session('current_location_id')) : null,
                'is_location_locked'      => (bool) $request->user()?->location_id,
                'locations'               => $request->user() ? \App\Models\Location::where('is_active', true)->get(['id', 'name', 'code']) : [],
            ],

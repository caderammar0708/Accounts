...
export default function RoleCreate({ groupedPermissions = {} }) {
                ...
                <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-black text-slate-900 tracking-tight">Create New Role</h1>
                                <p className="text-xs text-slate-500 font-medium mt-0.5">Define a role name and configure access permissions</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p className="text-xs text-slate-500">
                                    {data.permissions.length} of {allPermissionNames.length} permissions selected
                                </p>
                            </div>
                        </div>

...
import { FaPlus, FaGasPump, FaCalendarAlt, FaTint, FaInfoCircle } from 'react-icons/fa';
                                        ...
                                        {dipReadings.data.length === 0 ? (
                                            <tr>
                                                <td colSpan="7" className="px-6 py-12 text-center text-slate-500">
                                                    <FaGasPump className="mx-auto text-4xl text-slate-300 mb-3" />

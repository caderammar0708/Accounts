                                                            ...
                                                            <div className="flex items-center justify-end gap-2 group min-w-[120px]">
                                                                {editingOpening[index] ? (
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        <button tabIndex="-1" onClick={() => toggleEditOpening(index)} className="opacity-0 group-hover:opacity-100 p-1 text-slate-400 hover:text-blue-500 transition-opacity" title="Edit Opening Reading">

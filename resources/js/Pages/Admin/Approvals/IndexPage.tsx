                                        ...
                                        <tr key={leave.id} className="hover:bg-slate-50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="text-sm font-bold text-slate-800">{leave.employee?.name}</div>
                                                        <div className="text-xs text-slate-500">{leave.employee?.employee_id}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    {breakReq.employee?.logo ? (
                                                        ...
                                                        <div className="h-8 w-8 rounded-full bg-slate-200 flex items-center justify-center text-xs font-bold text-slate-600">
                                                            {breakReq.employee?.name?.charAt(0)}
                                                        </div>
                                                    )}
                                                    <div>
                                                        <div className="text-sm font-bold text-slate-800">{breakReq.employee?.name}</div>
                                                        <div className="text-xs text-slate-500">{breakReq.employee?.employee_id}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
